...
from cinema.views import movie_list, movie_detail, GenreListCreateAPIView, GenreRetrieveUpdateDestroyAPIView, \
    ActorListCreateAPIView, ActorRetrieveUpdateDestroyAPIView, CinemaHallViewSet, MovieViewSet
